...
# %%
# settings # TODO: in helpers als set von settings
...
os.chdir(ConfigPaths().work_dir)        # TODO: Funktioniert das oder nicht? sieht falsch/ unsauber aus
...
# %%
# Functions # TODO: Move to helpers
def remove_url(txt):
...
# %%
# Tweet word frequency analysis # TODO: local search_words nicht überschreiben oder in extra Funktion
